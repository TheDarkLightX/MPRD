...
{\large Case-study artifact: MPRD\par}
...
The paper's case study is MPRD, where the loop checked 16,003 materialized what-ifs plus a compressed 75,599,999-combination independent frontier, found 0 reachable disaster witnesses, observed 0 fail-closed failures across receipt, blocker, provenance, and optional-conflict mutations, and opened the bounded research gate. The claim is intentionally bounded: it proves no global software safety theorem. It proves a replayable no-witness result for a named witness language, atlas, receipt set, checker, and depth.
