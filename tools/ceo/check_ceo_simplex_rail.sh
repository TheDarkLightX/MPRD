...
echo "[ceo-simplex-rail] strict crossover gate (POR must win for eval_iters>=200)"
python3 tools/ceo/check_ceo_simplex_sweep_strict.py "${TMP_JSON}" --min-eval-iters 200 --min-win-rate 0.75 --max-median-ratio 1.0
